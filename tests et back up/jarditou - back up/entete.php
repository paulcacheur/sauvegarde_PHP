...
<head>
      ...
      <!-- include("connexionDB.php");  lien avec DB désactivée car equire DB inlcus  dans fichiers quan dnécessaires -->
       ...
       <!-- Collapse button -->
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="liste.php">Liste des produits</a>
              </li>
              <li class="nav-item">
